...
namespace Graphene {
	...
	[Version (since = "1.2")]
	public struct Box {
		[CCode (cname = "graphene_box_alloc", has_construct_function = false, type = "graphene_box_t*")]
		public Box.alloc ();
	...
	[Version (since = "1.2")]
	public struct Euler {
		[CCode (cname = "graphene_euler_alloc", has_construct_function = false, type = "graphene_euler_t*")]
		public Euler.alloc ();
	...
	public struct Frustum {
		[CCode (cname = "graphene_frustum_alloc", has_construct_function = false, type = "graphene_frustum_t*")]
	...
	public struct Matrix {
		[CCode (cname = "graphene_matrix_alloc", has_construct_function = false, type = "graphene_matrix_t*")]
		[Version (since = "1.0")]
		public Matrix.alloc ();
		[Version (since = "1.0")]
		...
		[Version (since = "1.0")]
		public void to_float ([CCode (array_length = false)] out unowned float v[16]);
		[Version (since = "1.0")]
	...
	[Version (since = "1.2")]
	public struct Plane {
		[CCode (cname = "graphene_plane_alloc", has_construct_function = false, type = "graphene_plane_t*")]
		public Plane.alloc ();
	...
	public struct Point {
		public float x;
		public float y;
		[CCode (cname = "graphene_point_alloc", has_construct_function = false, type = "graphene_point_t*")]
		public Point.alloc ();
	...
	public struct Point3D {
		...
		public float y;
		public float z;
		[CCode (cname = "graphene_point3d_alloc", has_construct_function = false, type = "graphene_point3d_t*")]
	...
	[Version (since = "1.0")]
	public struct Quad {
		[CCode (cname = "graphene_quad_alloc", has_construct_function = false, type = "graphene_quad_t*")]
		public Quad.alloc ();
	...
	public struct Quaternion {
		[CCode (cname = "graphene_quaternion_alloc", has_construct_function = false, type = "graphene_quaternion_t*")]
	...
	[Version (since = "1.4")]
	public struct Ray {
		[CCode (cname = "graphene_ray_alloc", has_construct_function = false, type = "graphene_ray_t*")]
		public Ray.alloc ();
	...
	public struct Size {
		public float width;
		public float height;
		[CCode (cname = "graphene_size_alloc", has_construct_function = false, type = "graphene_size_t*")]
		public Size.alloc ();
	...
	public struct Sphere {
		[CCode (cname = "graphene_sphere_alloc", has_construct_function = false, type = "graphene_sphere_t*")]
		public Sphere.alloc ();
		public bool contains_point (Graphene.Point3D point);
		public float distance (Graphene.Point3D point);
	...
	public struct Triangle {
		[CCode (cname = "graphene_triangle_alloc", has_construct_function = false, type = "graphene_triangle_t*")]
	...
	public struct Vec2 {
		...
		[CCode (cname = "graphene_vec2_alloc", has_construct_function = false, type = "graphene_vec2_t*")]
		[Version (since = "1.0")]
		public Vec2.alloc ();
		[Version (since = "1.0")]
		...
		[Version (since = "1.0")]
		public void to_float ([CCode (array_length = false)] out unowned float dest[2]);
		[Version (since = "1.0")]
	...
	public struct Vec3 {
		...
		[CCode (cname = "graphene_vec3_alloc", has_construct_function = false, type = "graphene_vec3_t*")]
		[Version (since = "1.0")]
		public Vec3.alloc ();
		[Version (since = "1.0")]
		...
		[Version (since = "1.0")]
		public void to_float ([CCode (array_length = false)] out unowned float dest[3]);
		[Version (since = "1.0")]
	...
	public struct Vec4 {
		...
		[CCode (cname = "graphene_vec4_alloc", has_construct_function = false, type = "graphene_vec4_t*")]
		[Version (since = "1.0")]
		public Vec4.alloc ();
		[Version (since = "1.0")]
		...
		[Version (since = "1.0")]
		public void to_float ([CCode (array_length = false)] out unowned float dest[4]);
		[Version (since = "1.0")]
